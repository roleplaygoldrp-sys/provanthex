    ...
    fetch('/api/specialists')
      ...
      .then(data => {
        ...
        if (data.specialists?.length > 0) {
          setSelectedSpecialist(data.specialists[0].id)
        }
      })
  }, [])
    ...
    <div className="flex flex-col h-[calc(100vh-8rem)]">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white">Nova Conversa</h1>
            <p className="text-sm text-slate-400">Converse com nossa IA especializada</p>
          </div>
        </div>
      ...
      <Card className="flex-1 bg-slate-900 border-slate-800 flex flex-col overflow-hidden">
        ...
        <div className="p-4 border-b border-slate-800 flex flex-wrap items-center gap-4">
          ...
          {conversationId && (
            <Link href={`/chat/${conversationId}`} className="ml-auto">
